...
<div style="max-width: 1000px; margin: 2rem auto; padding: 0 1rem;">
    ...
    <div style="background: linear-gradient(to right, #000000, #000000); color: white; padding: 1.5rem 2rem; border-radius: 0.5rem 0.5rem 0 0;">
        <h2 style="font-size: 1.875rem; font-weight: bold; margin: 0;">Edit Surat Penawaran</h2>
        <p style="color: #ffffff; margin: 0.5rem 0 0 0;">Ubah data penawaran yang sudah ada</p>
    </div>
        ...
        <form action="{{ route('penawaran.update', $penawaran->id) }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor" class="form-input" 
                               value="{{ old('nomor', $penawaran->nomor) }}" 
                               placeholder="Contoh: 001/SP/2024" required>
                    </div>
            ...
            <div class="form-section">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="pemberi" class="form-input" 
                               value="{{ old('pemberi', $penawaran->pemberi) }}" 
                               placeholder="Nama pemberi penawaran" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Jenis Aset <span style="color: #ef4444;">*</span></label>
                        <input type="text" name="jenis_aset" class="form-input" 
                               value="{{ old('jenis_aset', $penawaran->jenis_aset) }}" 
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="maksud" rows="4" class="form-textarea" 
                              placeholder="Jelaskan maksud dari penawaran ini...">{{ old('maksud', $penawaran->maksud) }}</textarea>
                </div>

                <div class="form-group">
                    <label class="form-label">Tujuan</label>
                    <textarea name="tujuan" rows="4" class="form-textarea" 
                              placeholder="Jelaskan tujuan dari penawaran ini...">{{ old('tujuan', $penawaran->tujuan) }}</textarea>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="text" step="0.01" name="nilai_kebutuhan" class="form-input" 
                                   ...
                                   value="{{ old('nilai_kebutuhan', $penawaran->nilai_kebutuhan) }}" 
                                   placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="number" step="0.01" name="biaya" class="form-input" 
                                   style="padding-left: 3rem;" 
                                   value="{{ old('biaya', $penawaran->biaya) }}" 
                                   placeholder="0.00">
                        </div>
                    </div>
                </div>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="norek" class="form-input" 
                           value="{{ old('norek', $penawaran->norek) }}" 
