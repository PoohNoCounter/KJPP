        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #e5e7eb;">
                ...
                <td style="padding: 0.75rem; text-align: center;">
                    <a href="{{ route('penawaran.edit', $penawaran->id) }}" style="color: #2f2fdd; text-decoration: none; margin-right: 0.5rem;"><i class="bi bi-pencil-square"></i></a>
                    <form action="{{ route('penawaran.destroy', $penawaran->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" style="color:#991b1b ;background: none; border: none; cursor: pointer; font-size: 1rem;" onclick="return confirm('Yakin ingin menghapus?')"><i class="bi bi-trash3"></i></button>
                    </form>
                </td>
            </tr>
            @endforeach
